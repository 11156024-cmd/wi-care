    ...
    <div className="fixed inset-0 z-[110] bg-slate-50 flex flex-col animate-in slide-in-from-right duration-300 font-sans">
      ...
      <div className="bg-white px-4 py-3 shadow-sm border-b border-slate-200 flex items-center justify-between sticky top-0 z-20">
        ...
        <div className="flex items-center gap-2">
            ...
            <h1 className="font-bold text-lg text-slate-800">Ë£ùÁΩÆË®≠Â??áÊ†°Ê≠?/h1>
        </div>
        <div className="w-10" /> 
      </div>
        ...
        <div className="max-w-md mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden divide-y divide-slate-100">
             ...
             <div className="px-5 py-4 bg-slate-50 flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Á≥ªÁµ±?ÉÊï∏Ë®≠Â? (Configuration)</span>
             </div>
             ...
             <div className="p-5">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <label className="text-sm font-bold text-slate-700">ÂÆâË?‰ΩçÁΩÆ</label>
                </div>
                ...
                <div className="relative w-full">
                    ...
                    >
                        <option value="master_bath">‰∏ªËá•Êµ¥ÂÆ§ (Master Bath)</option>
                        <option value="guest_restroom">ÂÆ¢Áî®ÂªÅÊ? (Guest Room)</option>
                        <option value="bedroom">?•Êàø (Bedroom)</option>
                        <option value="living_room">ÂÆ¢Âª≥ (Living Room)</option>
                    </select>
                    <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 pointer-events-none" />
                </div>
                <p className="text-[10px] text-slate-400 mt-2 pl-1">
                    * Âª∫Ë≠∞ÂÆâË?È´òÂ∫¶ÔºöÈõ¢??1.5m - 2.0mÔºåÈÅø?çÈÅÆ?ΩÁâ©??                </p>
             </div>
             ...
             <div className="p-5">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <label className="text-sm font-bold text-slate-700">Á©∫È?Â§ßÂ?</label>
                </div>
             ...
             >
                <div className="flex-1 pr-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-bold text-slate-700">?óÂπ≤?æÊ®°Âº?(ÂØµÁâ©)</span>
                    </div>
                    <p className="text-xs text-slate-500 leading-relaxed pl-8">
                        ?üÁî®ÂæåÔ?Á≥ªÁµ±Â∞áËá™?ïÈ?ÊøæÈõ¢??50cm ‰ª•‰??ÑÂæÆÂ∞èÁßª?ïË??üÔ?‰ª•ÈÅø?çË??óÈÄ†Ê?Ë™§Â†±??                    </p>
                </div>
          ...
          <div className="pt-2">
             {isCalibrating ? (
                 <div className="bg-white rounded-2xl p-6 border border-indigo-100 shadow-lg text-center space-y-4 animate-in fade-in zoom-in-95">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-slate-800">Ê≠?ú®?°Ê≠£?∞Â?...</h3>
             ...
             <p className="text-[10px] text-slate-400 text-center mt-3 px-4">
                * ÈªûÊ?ÂæåË?‰øùÊ?Á©∫È?Ê∑®Á©∫ÔºåÁ≥ªÁµ±È?Á¥?5 ÁßíË??ñÁí∞Â¢ÉË??ØÂÄº„Ä?             </p>
          </div>
