    ...
    return (
      <Container>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
             ...
             <p className="mt-2 sm:mt-4 text-xl sm:text-2xl font-bold text-red-700 animate-bounce whitespace-nowrap">偵測到跌倒！</p>
        </div>
      </Container>
    );
  }
    ...
    return (
      <Container className="bg-gray-100 rounded-full border-4 border-gray-300">
        <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-gray-500 font-medium text-sm sm:text-base">連線中...</p>
        </div>
      </Container>
    );
  }
  ...
  return (
    <Container className="bg-green-50 rounded-full border-4 border-green-200 shadow-lg">
      ...
      <div className="absolute bottom-[15%] left-0 right-0 text-center">
         <p className="text-lg sm:text-2xl font-bold text-green-600 tracking-tight">狀態安全</p>
      </div>
    </Container>
  );
};
